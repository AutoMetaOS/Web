import{S as u,i as f,s as g,e as d,t as v,c as p,a as h,g as x,d as i,b as l,f as w,H as m,I as n,a6 as _,A as y}from"./vendor-04de4d0b.js";/* empty css                                            */function b(o){let t,s,r;return{c(){t=d("div"),s=d("pre"),r=v("Initialising..."),this.h()},l(e){t=p(e,"DIV",{class:!0});var a=h(t);s=p(a,"PRE",{class:!0,id:!0});var c=h(s);r=x(c,"Initialising..."),c.forEach(i),a.forEach(i),this.h()},h(){l(s,"class","w-100 svelte-19p418o"),l(s,"id","editor"),l(t,"class","w-50 h-100 p-rel fade-right")},m(e,a){w(e,t,a),m(t,s),m(s,r)},p:n,i:n,o:n,d(e){e&&i(t)}}}function j(o){const t=_(),s=r=>t("code",r);return y(()=>{["https://cdnjs.cloudflare.com/ajax/libs/ace/1.4.13/ace.min.js","https://cdnjs.cloudflare.com/ajax/libs/ace/1.4.13/mode-html.min.js","https://cdnjs.cloudflare.com/ajax/libs/ace/1.4.13/theme-chrome.min.js"].forEach(e=>{const a=document.createElement("script");a.type="text/javascript",a.src=e,document.body.appendChild(a)}),setTimeout(function(){let e=ace.edit("editor");e.setTheme("ace/theme/chrome"),e.session.setMode("ace/mode/html"),e.setOptions({useWrapMode:!0,wrapBehavioursEnabled:!0,wrap:!0,showPrintMargin:!1,fontSize:16,cursorStyle:"slim"}),e.on("change",function(){s(e.getValue())}),e.setValue(E)},2e3)}),[]}class S extends u{constructor(t){super();f(this,t,j,b,g,{})}}const E=`<svg viewbox="0 0 512 512" width="512" height="512" xmlns="http://www.w3.org/2000/svg">
<defs>
